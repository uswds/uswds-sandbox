...
<div class="fw-300 padding-top-2 padding-bottom-4 tablet:padding-top-4 tablet:padding-bottom-6">
  ...
  <div class="container-desktop margin-bottom-0 padding-x-4 padding-top-2 margin-top-0">
    <div class="row">
      <div class="col-8">
        <p class="sans-4 color-black-50 margin-top-0 margin-bottom-2 fw-400"><span class="color-black fw-800 padding-2px border-2px lh-smallest padding-bottom-0 margin-right-1">USWDS</span> Docs <span class="color-black">/</span> Style <span class="color-black">/</span> Colors</p>
          <h1 class="sans-14 fw-300 margin-top-0 lh-smaller margin-bottom-0">Project theme palette</h1>
      </div>
      <div class="col-4">
    ...
    <div class="row padding-top-3 border-top-1px">
      <div class="col-3 sidenav">
        <ul class="list-reset sans-6 fw-700">
      ...
      <div class="col-9 usa-prose padding-x-3 sans-8">
        ...
        <div class="row gap margin-y-4 text-align-center">
          <div class="col-fill">
            <a href="#0" class="display-flex flex-direction-column justify-content-center min-height-card-plus border border-radius-large padding-2 color-black-90 text-decoration-none border-color-black-20 hover:border-color-black-90 hover:border-width-2px">
              ...
              <p class="flex-auto width-full margin-bottom-0 sans-6 fw-700 lh-small margin-top-1">Theme palette gallery</p>
              <p class="alex-auto width-full margin-0 margin-top-1 sans-6 lh-small padding-bottom-1">View and download project theme palettes</p>
            </a>
          </div>
          <div class="col-fill">
            <a href="#0" class="display-flex flex-direction-column justify-content-center min-height-card-plus border border-radius-large padding-2 color-black-90 text-decoration-none border-color-black-20 hover:border-color-black-90 hover:border-width-2px">
              ...
              <p class="flex-auto width-full margin-bottom-0 sans-6 fw-700 lh-small margin-top-1">Get the design assets</p>
              <p class="alex-auto width-full margin-0 margin-top-1 sans-6 lh-small padding-bottom-1">Use project theme palettes in your Sketch files</p>
            </a>
          </div>
        </div>

        <h2 class="sans-10 margin-top-4 margin-bottom-4 border-top-1px padding-top-2">Using role-based palettes</h2>
        ...
        <div class="margin-top-4 margin-bottom-8">
          <div class="row gap-small">
            <div class="col-7 margin-bottom-1">
              <div class="border-bottom-1px mono-2 padding-bottom-p5">60%</div>
            </div>
            <div class="col-4">
              <div class="border-bottom-1px mono-2 padding-bottom-p5">30%</div>
            </div>
            <div class="col-1">
              <div class="border-bottom-1px mono-2 padding-bottom-p5">10%</div>
            </div>
          </div>
          <div class="row gap-small">
            <div class="col-7">
          ...
          <div class="row gap margin-top-2">
            <div class="col-auto row align-items-center">
              <div class="col-auto circle-2 background-color-blue-70v margin-right-1"></div>
              <div class="lh-smallest sans-4 fw-700 padding-top-2px ">Primary</div>
            </div>
            <div class="col-auto row align-items-center">
              <div class="col-auto circle-2 background-color-mint-50 margin-right-1"></div>
              <div class="lh-smallest sans-4 fw-700 padding-top-2px ">Secondary</div>
            </div>
            <div class="col-auto row align-items-center">
              <div class="col-auto circle-2 background-color-orange-30v margin-right-1"></div>
              <div class="lh-smallest sans-4 fw-700 padding-top-2px ">Accent warm</div>
            </div>
            <div class="col-auto row align-items-center">
              <div class="col-auto circle-2 background-color-cyan-20v margin-right-1"></div>
              <div class="lh-smallest sans-4 fw-700 padding-top-2px ">Accent cool</div>
            </div>
          </div>
        </div>
        <ul>
        ...
        <aside class="background-color-white-warm-3 padding-3 margin-y-4 border-radius-small">
          <div class="row gap-large">
            ...
            <div class="col-fill">
              <p class="margin-top-0 sans-6 fw-400">The <strong>primary</strong> color family of <code class="background-color-blue-70v color-white">Blue</code> occupies the majority of the non-neutral color on the page.</p>
              <p class="border-top margin-top-1 padding-top-1 sans-6 fw-400">The <strong>secondary</strong> color family of <code class="background-color-mint-50 color-white">Mint</code> functions as a background color for an occasional content type.</p>
              <p class="border-top margin-top-1 padding-top-1 sans-6 fw-400">The <strong>warm and cool accent color families</strong> of <code class="background-color-orange-40v color-black-90">Orange</code> and <code class="background-color-cyan-20v color-black-90">Cyan</code> serve as special call-to-action buttons and headings for special content.</p>
              <p class="border-top margin-top-1 padding-top-1 sans-6 fw-400"><strong>Neutral</strong> <code class="background-color-black-90 color-white">Black</code> is the color family of most text.</p>
            </div>
          </div>
        </aside>

        <h2 class="sans-10 margin-y-4 border-top-1px padding-top-2">Project theme palette grades</h2>
          ...
          <div class="col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">—</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">—</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-primary-lighter</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(primary, lighter)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-primary-light</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(primary, light)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-primary-base</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(primary, base)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-primary-vivid</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(primary, vivid)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-primary-large</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(primary, large)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-primary-darker</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(primary, darker)</span></li>
                </ul>
              </div><!-- color -->
            </div><!-- card -->
          </div><!-- column -->
          <div class="col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-secondary-light</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(secondary, light)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-secondary-base</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(secondary, base)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-secondary-vivid</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(secondary, vivid)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-secondary-dark</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(secondary, dark)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
          ...
          <div class="col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-accent-warm-base</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(accent-warm, base)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-accent-warm-dark</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(accent-warm, dark)</span></li>
                </ul>
              </div><!-- color -->
            </div><!-- card -->
          </div><!-- column -->
          <div class="col-6">
            <div class="margin-top-3 border border-radius-base padding-2">
              ...
              <div>
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-accent-cool-base</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(accent-cool, base)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="swatch-info list-reset mono-1 margin-top-1">
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-accent-cool-dark</span></li>
                  <li class="margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(accent-cool, dark)</span></li>
                </ul>
              </div><!-- color -->
            </div><!-- card -->
          </div><!-- column -->
          <div class="col-12">
            <div class="margin-top-3 border border-radius-base padding-2 background-color-white">
              ...
              <div>
                ...
                <ul class="row swatch-info list-reset mono-1 margin-top-1">
                  <li class="col-auto margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-neutral-lightest</span></li>
                  <li class="col-auto margin-left-auto margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(neutral, lightest)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="row swatch-info list-reset mono-1 margin-top-1">
                  <li class="col-auto margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-neutral-lighter</span></li>
                  <li class="col-auto margin-left-auto margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(neutral, lighter)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="row swatch-info list-reset mono-1 margin-top-1">
                  <li class="col-auto margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-neutral-light</span></li>
                  <li class="col-auto margin-left-auto margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(neutral, light)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="row swatch-info list-reset mono-1 margin-top-1">
                  <li class="col-auto margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-neutral-base</span></li>
                  <li class="col-auto margin-left-auto margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(neutral, base)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="row swatch-info list-reset mono-1 margin-top-1">
                  <li class="col-auto margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-neutral-dark</span></li>
                  <li class="col-auto margin-left-auto margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(neutral, dark)</span></li>
                </ul>
              </div><!-- color -->
              <div>
                <div class="row sans-1 border-top border-color-black-10 margin-top-2 padding-top-1p5">
                ...
                <ul class="row swatch-info list-reset mono-1 margin-top-1">
                  <li class="col-auto margin-y-2px border-0 padding-0"><span class="sans-2">Utility suffix:</span> <span class="token">-neutral-darker</span></li>
                  <li class="col-auto margin-left-auto margin-y-2px border-0 padding-0"><span class="sans-2">SASS:</span> <span class="token">color(neutral, darker)</span></li>
                </ul>
              </div><!-- color -->
            </div><!-- card -->
          </div><!-- column -->
        ...
        <h2 class="sans-10 margin-y-4 border-top-1px padding-top-2">Palette gallery</h2>
        ...
        <div class="row gap margin-top-4">
          <div class="col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="sans-5 margin-bottom-1 lh-smaller">Onondaga</h4>
              <ul class="list-reset row gap sans-1 fw-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">professional</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">young</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">natural</li>
              </ul><!-- tags -->
              <div class="row margin-top-2 align-items-center">
                <a href="#0" class="col-auto lh-smallest sans-1 fw-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
                </a><!-- palette-button -->
                <a href="#0" class="col-auto margin-left-auto color-black-90 sans-1 text-decoration-underline lh-smallest">See more examples</a>
              </div><!-- palette-actions -->
            </div><!-- palette-card -->
          </div>
          ...
          <div class="col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="sans-5 margin-bottom-1 lh-smaller">Federal <span class="fw-300">(Original USWDS)</span></h4>
              <ul class="list-reset row gap sans-1 fw-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">traditional</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">straightforward</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">trustworthy</li>
              </ul><!-- tags -->
              <div class="row margin-top-2 align-items-center">
                <a href="#0" class="col-auto lh-smallest sans-1 fw-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
          ...
          <div class="col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="sans-5 margin-bottom-1 lh-smaller margin-bottom-0">Pennant</h4>
              <ul class="list-reset row gap sans-1 fw-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">solid</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">friendly</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">energetic</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">outgoing</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">all-American</li>
              </ul><!-- tags -->
              <div class="row margin-top-2 align-items-center">
                <a href="#0" class="col-auto lh-smallest sans-1 fw-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
          ...
          <div class="col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3">
              ...
              <h4 class="sans-5 margin-bottom-1 lh-smaller">Marine</h4>
              <ul class="list-reset row gap sans-1 fw-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">no nonsense</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">professional</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">conservative</li>
              </ul><!-- tags -->
              <div class="row margin-top-2 align-items-center">
                <a href="#0" class="col-auto lh-smallest sans-1 fw-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
          ...
          <div class="col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3 display-flex flex-direction-column">
              <h4 class="sans-5 margin-bottom-p5 lh-smaller order-2">Cascade</h4>
              ...
              <ul class="order-3 list-reset row gap sans-1 fw-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">fresh</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">compassionate</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">energetic</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">healthy</li>
              </ul><!-- tags -->
              <div class="order-4 row margin-top-2 align-items-center">
                <a href="#0" class="col-auto lh-smallest sans-1 fw-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
                </a><!-- palette-button -->
                <a href="#0" class="col-auto margin-left-auto color-black-90 sans-1 text-decoration-underline lh-smallest">See more examples</a>
          ...
          <div class="col-6">
            <div class="palette-card border border-radius-small padding-1 margin-top-3 display-flex flex-direction-column">
              <h4 class="sans-5 margin-bottom-p5 lh-smaller order-2">Columbia</h4>
              <div class="row gap-2px order-first">
                <!-- ========================================= -->
                <div class="col-fill">
                  <div class="height-1 display-flex align-items-center">
              ...
              <ul class="order-3 list-reset row gap sans-1 fw-400 margin-bottom-0 margin-x-0 min-height-6 align-items-flex-start margin-top-p5">
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">clean</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">fresh</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5">earthy</li>
                <li class="col-auto border-0 background-color-white-warm-4 border-radius-small padding-y-p5 padding-x-1 lh-smallest margin-right-p5 margin-top-p5">earnest</li>
              </ul><!-- tags -->
              <div class="order-4 row margin-top-2 align-items-center">
                <a href="#0" class="col-auto lh-smallest sans-1 fw-400 padding-y-1 padding-x-2 background-color-black-90 color-white border-radius-small text-decoration-none">
                  Download palette ⇣
        ...
        <h2 class="sans-10 margin-y-4 border-top-1px padding-top-2">Downloading and using palettes</h2>
...
<pre class="max-width-full background-color-white-warm-4 padding-2 white-space-pre-wrap margin-y-4"><code class="mono-1 padding-0">@import 'uswds-project-settings';
