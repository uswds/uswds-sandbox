...
<div class="clearfix container-tablet-lg padding-x-2 padding-top-6 line-height-sans-1 margin-bottom-9">
  ...
  <div class="row gap flex-align-center text-400 padding-bottom-2 margin-bottom-2 border-bottom-1px border-gray-20">
  ...
  <div class="row gap text-400 padding-bottom-2 margin-bottom-2 border-bottom-1px border-gray-20">
    <div class="col-4 display-flex flex-column flex-justify-end">
