...
<div class="font-mono-4 weight-300 padding-top-2 padding-bottom-4 tablet:padding-top-4 tablet:padding-bottom-9">
  ...
  <div class="container-tablet-lg padding-x-2 margin-top-1">
    ...
    <div class="row margin-top-1">
      <div class="col-6 tablet-lg:col-fill border-1px border-black-cool-10">
        <div class="none tablet-lg:block center padding-2">.tablet-lg:col</div>
        <div class="tablet-lg:none center padding-2">.col-6</div>
      </div>
      ...
      <div class="col-4 tablet-lg:col-fill border-1px border-top-width-0 tablet-lg:border-top-width-1px tablet-lg:border-left-width-0 border-black-cool-10">
        <div class="none tablet-lg:block center padding-2">.tablet-lg:col</div>
        <div class="tablet-lg:none center padding-2">.col-4</div>
      </div>
    ...
    <div class="row margin-top-1">
      <div class="col tablet:col-fill border-1px border-black-cool-10">
        <div class="none tablet:block center padding-2">.tablet:col</div>
        <div class="tablet:none center padding-2">.col</div>
      </div>
    ...
    <div class="row margin-top-1">
      ...
      <div class="col-fill border-1px border-left-0 border-black-cool-10">
        <div class="center padding-2">.col</div>
      </div>
      <div class="col-fill border-1px border-left-0 border-black-cool-10">
        <div class="center padding-2">.col</div>
      </div>
