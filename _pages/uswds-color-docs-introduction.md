...
<div class="mono-4 fw-300 padding-top-2 padding-bottom-4 tablet:padding-top-4 tablet:padding-bottom-6 background-color-white-1">
  ...
  <div class="container-desktop margin-bottom-0 padding-x-4 padding-top-2 margin-top-0">
    <div class="row">
      <div class="col-8">
        <p class="sans-4 color-black-50 margin-top-0 margin-bottom-2 fw-400"><span class="color-black fw-800 padding-2px border-2px lh-smallest padding-bottom-0 margin-right-1">USWDS</span> Docs <span class="color-black">/</span> Style <span class="color-black">/</span> Colors</p>
          <h1 class="sans-14 fw-300 margin-top-0 lh-smaller margin-bottom-0">An introduction to color</h1>
      </div>
      <div class="col-4">
    ...
    <div class="row margin-top-0 border-top-1px padding-top-3">
      ...
      <div class="col-fill usa-prose padding-x-3 sans-8">

        <!-- ###################################################### -->

        <p class="sans-11 fw-300 lh-base margin-top-0">Color is a practical and emotional tool. It conveys personality, sets a tone, attracts attention, and indicates importance.</p>

        <h2 class="sans-10 margin-top-4 margin-bottom-4 border-top-1px padding-top-2">Overview</h2>
        ...
        <aside class="background-color-white-warm-3 padding-3 margin-y-4 border-radius-small fw-400 sans-6">
          <h4 class="margin-top-0 text-transform-uppercase sans-4 letter-spacing-loose margin-bottom-0">Color, color family, and grade</h4>
          <p class="fw-400 sans-6 margin-top-1">Throughout our documentation and guidance, we’ll use use the terms <em>color</em>, <em>color family</em>, and <em>grade</em>, but what do we mean when we use them?</p>
          <p class="fw-400 sans-6"><strong>Color</strong> is any specific swatch in our palettes, like <code>red 50</code>, <code>primary base</code>, or <code>indigo warm 60v</code>.</p>
          <p class="fw-400 sans-6"><strong>Color family</strong> is a group of colors that all have the same hue on a color wheel (See <a href="#0">USWDS color wheels</a>, below.) They contain a number of individual colors, distinguished by the brightness or saturation of each individual color. A color family is typically a conventional color name like <code>red</code> or <code>blue warm</code>, or could be a use-based name in the project theme palette, like <code>primary</code>. </p>
          <p class="fw-400 sans-6"><strong>Grade</strong> is a way to express how light or dark a color is. USWDS uses <a href="#0">a 100-point scale</a> to communicate the grade, where 0 is pure white and 100 is pure black. We’ve regularized these grades across color families: a color of grade <code>50</code> in one color family should be the same level of lightness as a color of grade <code>50</code> in another color family. This has important color contrast and accessibility implications that we’ll discuss <a href="#0">later</a>.</p>
        </aside>

        <h2 class="sans-10 margin-top-6 margin-bottom-4 border-top-1px padding-top-2">Color and accessibility</h2>
        ...
        <h2 class="sans-10 margin-top-4 margin-bottom-4 border-top-1px padding-top-2">Accessible color pairings</h2>
        ...
        <div class="border-1px padding-2 border-radius-small margin-top-4">
          <p class="sans-5 fw-700 margin-top-0 margin-bottom-1">Black</p>
        ...
        <div class="row gap mono-2 fw-400">
          <div class="col-fill">
        ...
        <p class="sans-5 fw-400 max-width-measure-small lh-base margin-y-2 padding-bottom-2"><strong>Above:</strong> Since <code>90 – 50 = 40</code>, on a background of <code>black 90</code> use grades of <code>40</code> and below to assure Section 508 AA contrast. Grades of <code>50</code> and below are acceptable for large text.</p>

        <div class="row gap mono-2 fw-400 margin-y-4">
          <div class="col-fill">
            <div class="background-color-black-90 padding-2  padding-bottom-4 border-radius-small is-inverse">
        ...
        <p class="sans-5 fw-400 max-width-measure-small lh-base margin-y-2 padding-bottom-2"><strong>Above:</strong> The color grade system works across color families.</p>
        ...
        <h2 class="sans-10 margin-top-6 margin-bottom-4 border-top-1px padding-top-2">USWDS color wheels</h2>
        ...
        <h2 class="sans-10 margin-top-6 margin-bottom-4 border-top-1px padding-top-2">Using color</h2>
        ...
        <h2 class="sans-10 margin-top-6 margin-bottom-4 border-top-1px padding-top-2">Pairing colors</h2>
        <p>Section TK</p>

        <h2 class="sans-10 margin-top-6 margin-bottom-4 border-top-1px padding-top-2">References</h2>
        <p>Section TK</p>
